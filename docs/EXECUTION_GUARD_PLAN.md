...
## Fase 1 — Sandbox Real (Docker rootless, rede bloqueada)
...
## Fase 1 — Aprovação Humana Fora do Agente
...
## Fase 2 — RAG Confiável (pgvector obrigatório em prod)
...
## Fase Transversal — Observabilidade & Auditoria
